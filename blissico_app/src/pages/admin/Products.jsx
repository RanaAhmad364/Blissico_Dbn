...
const Products = () => {
  ...
  const [animatedGifFile, setAnimatedGifFile] = useState(null);
  ...
  const handleSubmit = async (e) => {
    ...
    if (animatedGifFile) fd.append('animated_gif', animatedGifFile);
          ...
          <div className="card-form-card">
            ...
            <form onSubmit={handleSubmit} className="card-form">
              <div className="form-grid">
                ...
                <div className="form-group full-width">
                  <label>Animated GIF {form.id && <span className="hint">(leave empty to keep current)</span>}</label>
                  <input type="file" accept="image/gif" onChange={(e) => setAnimatedGifFile(e.target.files[0])} />
                </div>
              </div>
