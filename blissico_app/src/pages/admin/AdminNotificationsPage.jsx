      ...
      <div style={{ padding: '32px 24px', maxWidth: 980, margin: '0 auto' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
          <div>
            ...
            <p style={{ margin: '8px 0 0', color: '#64748b' }}>Admin overview of system notices and account activity.</p>
          </div>
          <button
          ...
          <div style={{ display: 'grid', gap: 16 }}>
            {notifications.map((item) => (
              <div
                key={item.id}
                style={{
                  background: item.is_read ? '#fff' : '#f3e8ff',
                  border: item.is_read ? '1px solid #e2e8f0' : '1px solid #d8b4fe',
                  borderRadius: 12,
                  padding: 18,
